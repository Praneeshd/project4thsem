...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style='background-color:#37517e'>
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://localhost:8080/EmailVerification/index.php">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li>
                    <a href="http://localhost::8080/EmailVerification/index.php" data-toggle="collapse" data-target="#submenu-1"><i class="fa fa-fw fa-search"></i><mark> Dashboard</mark> <i class="fa fa-fw fa-angle-down pull-right"></i></a>
                   
                </li>
                <li><a class="nav-link scrollto" href="notice/notice.php"><span class="fa fa-bell"> Notice </span></a></li>
                <li>
   ...
   $hostForImage ="http://localhost:8080/EmailVerification/phpGmailSMTP/upload/";
...
function confirmDelete(){
    window.location.replace("http://localhost:8080/EmailVerification/adminlogin/admindelete.php?i="+delId);
}
</script>
</body>
</html>