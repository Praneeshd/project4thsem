...
#ch {
 ...
 overflow: hidden;
   ...
   <body> 
   <div class="sidebar">
  <a href="http://localhost:8080/EmailVerification/index.php"  class="fa fa-home"><strong> Home - <img src="Capture.PNG" alt="LOGO"heigth='30'width='30'class='logo1'>
 </strong></a>
  <!-- <a href="#news">News</a>
...
function confirmDelete(){
    window.location.replace("http://localhost:8080/EmailVerification/adminlogin/delete.php?i="+delId);
}
</script>
</body>
</html>
